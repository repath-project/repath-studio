...
(def app
  [:map {:closed true}
   ...
   [:pointer-pos {:default [0 0]} math/vec2d]
   [:pointer-offset {:optional true} math/vec2d]
   [:adjusted-pointer-pos {:default [0 0]} math/vec2d]
   [:adjusted-pointer-offset {:optional true} math/vec2d]
   ...
   [:snap {:persisted true} snap.db/snap]
   ...
   [:documents {:default {} :persisted true} [:map-of uuid? document.db/document]]
   ...
   [:fx {:default []} vector?]
   [:pivot-point {:optional true} math/vec2d]
